...
const moods = [
  { emoji: "😌", label: "Comfort", color: "bg-amber-100 dark:bg-amber-900/30 text-amber-900 dark:text-amber-100" },
  { emoji: "🔥", label: "Spicy", color: "bg-red-100 dark:bg-red-900/30 text-red-900 dark:text-red-100" },
  { emoji: "🌿", label: "Healthy", color: "bg-emerald-100 dark:bg-emerald-900/30 text-emerald-900 dark:text-emerald-100" },
  { emoji: "🎉", label: "Festive", color: "bg-purple-100 dark:bg-purple-900/30 text-purple-900 dark:text-purple-100" },
  { emoji: "💕", label: "Romantic", color: "bg-pink-100 dark:bg-pink-900/30 text-pink-900 dark:text-pink-100" },
  { emoji: "⚡", label: "Quick", color: "bg-yellow-100 dark:bg-yellow-900/30 text-yellow-900 dark:text-yellow-100" },
  { emoji: "🌙", label: "Cozy", color: "bg-indigo-100 dark:bg-indigo-900/30 text-indigo-900 dark:text-indigo-100" },
]
